...
function prfSampleModel_symmetry_computeCanada(isub,visualRegion, method)
...
featurefolder = '/home/hanseohe/scratch/stimuli/parfilter/';%to save model outputs
...
for roinum=1:length(rois)
    ...
    prffolder = '/home/hanseohe/projects/def-waltherd/hanseohe/nsddata/prfsample_Par/';
