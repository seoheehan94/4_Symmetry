...
[~,M,mr] = load_mgh('/bwlab/Users/SeoheeHan/NSDData/rothzn/nsd/Symmetry/surfaceData/sub1/contourBrain_sub1_lh_fsaverage.mgh');
...
for curcond = 1:3
    ...
    %% only R2 > 0 and remove extreme values
