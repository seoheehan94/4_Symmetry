...
function prfSampleModel_symmetry_computeCanada(isub,visualRegion,type,method)
...
for roinum=1:length(rois)
    ...
    prffolder = ['/home/hanseohe/projects/def-waltherd/hanseohe/nsddata/prfsample_',type,'/'];
